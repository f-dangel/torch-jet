\resizebox{0.7\linewidth}{!}{\begin{tikzpicture}
  \tikzset{transparentfill/.style={fill=white, fill opacity=0.8, text opacity=1.0}}
  \begin{axis}[
    axis lines=middle,
    ...
    \node[anchor=south west, transparentfill, xshift=2pt, yshift=2pt] at (axis cs:0,4) {$\gamma_{{(2, 2), (4,0)}} = \frac{13}{192} $};
    \node[anchor=south west, transparentfill, xshift=2pt, yshift=2pt] at (axis cs:1,3) {$\gamma_{{(2, 2), (1,3)}} = -\frac{1}{3} $};
    \node[anchor=south west, transparentfill, xshift=2pt, yshift=2pt] at (axis cs:2,2) {$\gamma_{{(2, 2), (2,2)}} = \frac{5}{8} $};
    \node[anchor=south west, transparentfill, xshift=2pt, yshift=2pt] at (axis cs:3,1) {$\gamma_{{(2, 2), (3,1)}}$};
    \node[anchor=south west, transparentfill, xshift=2pt, yshift=2pt] at (axis cs:4,0) {$\gamma_{{(2, 2), (4,0)}}$};
  \end{axis}

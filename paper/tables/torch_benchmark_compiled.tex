\begin{table}[!b]
  \centering
  \caption{\textbf{Same as \cref{tab:benchmark}, but using \texttt{torch.compile}.}}
  ...
  \def\datapathWeightedLaplacianExact{jet/exp/exp01_benchmark_laplacian/performance/architecture_tanh_mlp_768_768_512_512_1_compiled_device_cuda_dim_50_name_weighted_laplacian_vary_batch_size}
  \def\datapathWeightedLaplacianStochastic{jet/exp/exp01_benchmark_laplacian/performance/architecture_tanh_mlp_768_768_512_512_1_batch_size_2048_compiled_device_cuda_dim_50_distribution_normal_name_weighted_laplacian_vary_num_samples}
  ...
  \begin{small}
    \begin{tabular}{ccc|cccc}
      ...
      & \input{\datapathBilaplacianExact/jet_simplified_peakmem_nondifferentiable.txt}
      \\
      \midrule

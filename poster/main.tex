    ...
    \begin{center}
      \resizebox{!}{12cm}{%
        {\tikzset{%
          ...
          \begin{tikzpicture}
            \node [inner xsep=80pt, inner ysep=30pt, draw=tab-orange, rounded corners=15pt, line width=10pt] (graph-before) {\input{../paper/figures/sin_2jet_5.tex}};
            ...
            \node [inner xsep=80pt, inner ysep=30pt, draw=tab-orange, rounded corners=15pt, line width=10pt] at (graph-before) {\input{../paper/figures/sin_2jet_5.tex}};
    ...
    \begin{center}
      \resizebox{!}{12cm}{
        {\tikzset{%
          ...
          \begin{tikzpicture}
            \node[inner xsep=80pt, inner ysep=20pt, draw=tab-green, rounded corners=15pt, line width=10pt] (graph-after) {\input{../paper/figures/sin_2jet_8.tex}};
            ...
            % Re-draw
            \node[inner xsep=80pt, inner ysep=20pt, draw=tab-green, rounded corners=15pt, line width=10pt] at (graph-after) {\input{../paper/figures/sin_2jet_8.tex}};

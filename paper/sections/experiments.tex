...
\begin{figure*}[!t]
  ...
  \begin{tabular}{CDDD}
    ...
    & \includegraphics{../jet/exp/exp01_benchmark_laplacian/figures/architecture_tanh_mlp_768_768_512_512_1_device_cuda_dim_5_name_dangel2024kroneckerfactored_bilaplacian_vary_batch_size.pdf}
    \\
    \textbf{Stochastic}
    ...
    & \includegraphics{../jet/exp/exp01_benchmark_laplacian/figures/architecture_tanh_mlp_768_768_512_512_1_batch_size_256_device_cuda_dim_5_distribution_normal_name_dangel2024kroneckerfactored_bilaplacian_vary_num_samples.pdf}
  \end{tabular}

...
\newsavebox{\legend2}
\savebox{\legend2}{
  \begin{tikzpicture}[font=\small, scale=0.6, every node/.style={scale=0.6}]
    \matrix [
      matrix of nodes,
...
\begin{tikzpicture}
  ...
  \node[rectangle, draw=gray, rounded corners, inner sep=-1pt, anchor=north west, xshift=1.35cm, fill=white, fill opacity=0.8, text opacity=1.0] at (image.north west) {\usebox{\legend2}};
\end{tikzpicture}

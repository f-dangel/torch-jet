\begin{table}[!b]
  ...
  \caption{\textbf{Exact weighted Laplacian for different ranks of the weightings.}
    ...
    Both scale approximately linear with the rank, as predicted by our theoretical analysis based on the number of forward-propagated coefficients.
  ...
  \begin{small}
    \begin{tabular}{ccc|ccc}
      ...
      % & \textbf{\input{\datapathExactLowRankCompiled/jet_naive_peakmem_nondifferentiable.txt}}
      \\
      &
      & \textcolor{tab-green}{Collapsed (ours)}
      ...
      % & \input{\datapathExactLowRankCompiled/jet_simplified_peakmem_nondifferentiable.txt}
      \\
      \midrule

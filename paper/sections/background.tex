...
To generalize of \cref{eq:faa-di-bruno} to higher dimensions, we will introduce the notation $\partial^kf[x_{i_1}, \dots, x_{i_k}]$ to indicate the contraction of the tensor containing the $k$-th order partial derivatives with the vectors $x_{i_1}, \dots x_{i_k}$.

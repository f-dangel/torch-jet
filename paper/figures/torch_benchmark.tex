\begin{figure*}[!b]
  ...
  \begin{tabular}{CDEE}
    ...
    &  \includegraphics[trim={0.45cm 0 0 0},clip]{jet/exp/exp01_benchmark_laplacian/figures/architecture_tanh_mlp_768_768_512_512_1_device_cuda_dim_50_name_weighted_laplacian_vary_batch_size_rank_ratio_1_0.pdf}
  ...
  \scalebox{0.85}{
    ...
    & \includegraphics[trim={0.45cm 0 0 0},clip]{jet/exp/exp01_benchmark_laplacian/figures/architecture_tanh_mlp_768_768_512_512_1_batch_size_2048_device_cuda_dim_50_distribution_normal_name_weighted_laplacian_vary_num_samples_rank_ratio_1_0.pdf}
  ...
  \caption{\textbf{\textcolor{tab-green}{Collapsed Taylor mode} accelerates \textcolor{tab-orange}{standard Taylor mode} and outperforms \textcolor{tab-blue}{nested 1\textsuperscript{st}-order AD}.}

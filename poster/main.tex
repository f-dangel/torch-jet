...
\begin{columns}
  ...
  \block{Background: What is Taylor Mode Autodiff?}{
    ...
    \begin{center}
      \begin{tikzpicture}
        \node [inner xsep=80pt, inner ysep=30pt, draw=tab-orange, rounded corners=15pt, line width=10pt] (graph-before) {\includegraphics[height=11.5cm]{figures/sin_2jet_before}};
        ...
        % Re-draw
        \node [inner xsep=80pt, inner ysep=30pt, draw=tab-orange, rounded corners=15pt, line width=10pt] {\includegraphics[height=11.5cm]{figures/sin_2jet_before}};
  ...
  \block{Main Idea: Use Linearity to Collapse the Propagation}{
    ...
    \begin{center}
      ...
      % }
      \begin{tikzpicture}
        \node [inner xsep=80pt, inner ysep=30pt, draw=tab-green, rounded corners=15pt, line width=10pt] (graph-after) {\includegraphics[height=11.5cm]{figures/sin_2jet_after}};
        ...
        % Re-draw
        \node [inner xsep=80pt, inner ysep=30pt, draw=tab-green, rounded corners=15pt, line width=10pt] {\includegraphics[height=11.5cm]{figures/sin_2jet_after}};

...
\begin{columns}
  ...
  \begin{column}{1.85}
    \centering \ribbon{\centering\fontsize{120}{80}\selectfont\textcolor{white}{\bf
        \underline{TL;DR:}\quad We accelerate Taylor mode for practical differential operators. \\[0.5ex]
        \hspace{-3.5ex}\underline{\phantom{;\!}How:}\quad By linearity-based graph rewrites that collapse the propagation.}}
  \end{column}
\end{columns}
\hspace{2cm}
  ...
  \block{Background: What is Taylor Mode Autodiff?}{
    ...
    \hspace*{-0.1cm}
      \begin{tikzpicture}
        ...
        \node [anchor=north east, align=center, yshift=3cm] at (separator) {\textbf{Propagate then sum}};
      \end{tikzpicture}
  }
  ...
  \block{Main Idea: Use Linearity to Collapse the Propagation}{
    ...
    % Example: Collapsing multiple 2-jets of the sine function.
      ...
      \begin{tikzpicture}
        ...
        \node [anchor=north east, align=center, yshift=3cm] at (separator) {\textbf{Sum then propagate}};
      \end{tikzpicture}
      % }
      % }
  }

...
\end{equation}
To occasionally simplify the notation we will use $\vv_k^{\otimes K} = \otimes_{k=1}^K \vv_k$.
...
\begin{center}
  \begin{tikzpicture}
    ...
    \draw [-Latex, \colorTM] (bottomleft.east) to node [midway, above, tab-orange] {\textcolor{\colorTM}{Taylor mode}
    } (bottomright.west);
  \end{tikzpicture}
\end{center}

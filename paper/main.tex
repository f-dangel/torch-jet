...
\input{paper/sections/appendix_numerical_analysis}

% Include the checklist except for the pre-print version
\ifthenelse{\equal{\status}{preprint}}{}{
\newpage
% This command creates an un-numbered section and adds it to the table of contents
% (see https://www.reddit.com/r/LaTeX/comments/10pjrwt/comment/j6kvo50/?utm_source=share&utm_medium=web3x&utm_name=web3xcss&utm_term=1&utm_content=share_button)

...
Since nested AD is expensive, efficient automatic differentiation of such operators must therefore go beyond mere backpropagation, a realization that motivated this fact and previous work is illustrated in Figure \ref{fig:benchmark}.

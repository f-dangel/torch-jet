  ...
  \block{Background: What is Taylor Mode Autodiff?}{
    ...
    \begin{center}
        {\tikzset{%
          ...
          \begin{tikzpicture}
            \node [inner xsep=80pt, inner ysep=30pt, draw=tab-orange, rounded corners=15pt, line width=10pt] (graph-before) {\scalebox{0.5}{\input{../paper/figures/sin_2jet_5.tex}}};
            ...
            \node [inner xsep=80pt, inner ysep=30pt, draw=tab-orange, rounded corners=15pt, line width=10pt] at (graph-before) {\scalebox{0.5}{\input{../paper/figures/sin_2jet_5.tex}}};
  ...
  \block{Main Idea: Use Linearity to Collapse the Propagation}{
    ...
    \begin{center}
        {\tikzset{%
          ...
          \begin{tikzpicture}
            \node[inner xsep=80pt, inner ysep=20pt, draw=tab-green, rounded corners=15pt, line width=10pt] (graph-after) {\scalebox{0.5}{\input{../paper/figures/sin_2jet_8.tex}}};
            ...
            % Re-draw
            \node[inner xsep=80pt, inner ysep=20pt, draw=tab-green, rounded corners=15pt, line width=10pt] at (graph-after) {\scalebox{0.5}{\input{../paper/figures/sin_2jet_8.tex}}};
